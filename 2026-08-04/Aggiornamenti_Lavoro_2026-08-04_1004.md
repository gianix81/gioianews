...
*Martedì 4 agosto 2026, run h1004: ricerche mirate ripetute su INPS (Circolari e Messaggi), Agenzia delle Entrate, Gazzetta Ufficiale/Normattiva, Ministero del Lavoro, INL, INAIL, CNEL e Cassazione. Nessuna nuova norma certificata del settore privato con impatto diretto sulla busta paga rispetto alla run h0605 di stamattina. Quadro parametri 2026 invariato.* Elementi ancora "caldi" della finestra 30 giorni, tutti già valorizzati e a registro:

1. 🔥 ✅ **Cedolino agosto 2026: il mese che "cambia di più".** Conguaglio 730 (rimborsi/trattenute IRPEF) + ripresa addizionali regionali/comunali → netto tipicamente più basso per molti dipendenti. [EnacInforma](https://www.enacinforma.it/conguagli-730-cedolino-agosto/)
...
Nessuna novità normativa del settore privato con decorrenza operativa nella giornata. Le ricerche mirate su INPS (Circolari e Messaggi), Agenzia delle Entrate (circolari/risoluzioni/FAQ), Gazzetta Ufficiale/Normattiva, Ministero del Lavoro, INL, INAIL, CNEL e Cassazione non hanno restituito atti nuovi rispetto alle run precedenti. Confermato periodo estivo di bassa produzione normativa.
...
- **Previdenza complementare — prestazioni:** dal 01/07/2026 fissata al **50%** la quota massima del montante finale erogabile in capitale (DL 62/2026 conv. L. 112/2026). ✅ [IPSOA](https://www.ipsoa.it/documents/quotidiano/2026/06/29/decreto-lavoro-2026-cambia-resta-legge-conversione-g-u)
- **Detassazione premi/aumenti/notturno-festivo-turni:** imposta sostitutiva 5% aumenti da CCNL (redditi ≤33.000 €) e 15% su notturno/festivo/turni entro 1.500 € (redditi ≤40.000 €). ✅ [Agenzia Entrate — Circ. 3/E](https://www.agenziaentrate.gov.it/portale/circolari-2026)
- **Fringe benefit 2026:** soglie 1.000 € (tutti) / 2.000 € (con figli a carico); meccanismo "a soglia" (superamento anche di 1 € → tassazione dell'intero importo). Chiarimenti in Risoluzione AE 22/2026 (09/06/2026). ✅ [MEFOP](https://www.mefop.it/blog/blog-mefop/fringe-benefit-conversione-dl-chiarimenti-agenzia-entrate)
...
**Giurisprudenza (finestra ampia, riscontro, non a payload perché fuori 30 gg stretti):**
- **Cass. ord. n. 18529 del 08/06/2026** — durante le ferie la retribuzione deve essere comparabile a quella ordinaria (non necessariamente identica); il giudice verifica se l'esclusione di una voce collegata alle mansioni produca una riduzione tale da dissuadere dal godimento delle ferie. ✅ [FiscoeTasse](https://www.fiscoetasse.com/new-rassegna-stampa/3752-retribuzione-ferie-le-regole-della-cassazione.html)
- **Cass. n. 20151 del 03/06/2026** — ai fini del reato di sfruttamento del lavoro la retribuzione non si valuta solo dall'importo in busta: rilevano anche contributi, ferie, malattia, maternità e condizioni complessive. ✅ (rilievo penale, non calc-critico) [Milano Post](https://www.milanopost.info/2026/07/15/sfruttamento-del-lavoro/)
...
## 3. DIFF vs ultimo report (2026-08-04 h0605)

| Tema | Stato h0605 | Oggi h1004 |
|---|---|---|
...
| Fringe benefit 2026 (soglie + Ris. AE 22/2026) | riscontro | ribadito ✅ (riscontro finestra) |
| Parametri di calcolo 2026 | invariati | invariati |
| Dataset CCNL | invariato | invariato |

**Nuove norme certificate rispetto a h0605:** nessuna. **Decadute:** nessuna.
...
I valori correnti sono salvati nel file `parametri_2026-08-04_1004.json` (accanto a questo report). Sintesi:
...
- [Ministero del Lavoro — Decreto Lavoro](https://www.lavoro.gov.it/notizie/pagine/il-consiglio-dei-ministri-approva-il-decreto-lavoro)
...
- [MEFOP — Fringe benefit: chiarimenti Agenzia Entrate](https://www.mefop.it/blog/blog-mefop/fringe-benefit-conversione-dl-chiarimenti-agenzia-entrate)
...
- [FiscoeTasse — Retribuzione ferie, regole Cassazione](https://www.fiscoetasse.com/new-rassegna-stampa/3752-retribuzione-ferie-le-regole-della-cassazione.html)
...
*Report generato automaticamente — run h1004 del 2026-08-04. Ogni dato calc-critico è marcato con affidabilità e fonte; i valori vanno riscontrati su fonte ufficiale prima dell'uso in produzione.*
