...
*Venerdì 7 agosto 2026, run h1603. Ricerca su INPS (Circolari e Messaggi), Agenzia delle Entrate, Gazzetta Ufficiale/Normattiva, Ministero del Lavoro, INL, INAIL, CNEL e Cassazione. INPS in sospensione estiva notifiche (Msg 2371/2026, 27/07–31/08/2026): flusso di prassi ridotto al minimo. **Nessun nuovo atto certificato con impatto diretto sul calcolo del cedolino privato** rispetto alle run del 07/08 (h0603 e h1003). Quadro parametri IRPEF/INPS/cuneo/TFR/NASpI 2026 invariato.*

1. 🔥 ✅ **Nessuna nuova norma calc-critica nella finestra/fascia.** Il quadro certificato per il cedolino privato resta consolidato: IRPEF 23/33/43%, cuneo 2026, detassazione incrementi retributivi/indennità (chiarimenti AdE 2026), NASpI (incl. Msg 2540/2026 dimissioni per violenza di genere), indennità malattia/maternità (Circ. INPS 75/2026), previdenza complementare (L. 112/2026). [INPS — Circolari e Messaggi](https://www.inps.it/it/it/inps-comunica/atti/circolari-messaggi-e-normativa.html)
2. ⏳ **Metalmeccanica PMI — CONFAPI: ipotesi di accordo di rinnovo CCNL.** Firmata l'ipotesi (settore metalmeccanico PMI/Confapi): aumenti tabellari da definire e recepire. **In iter**, non ancora efficace ai fini busta finché non sottoscritto in via definitiva e con decorrenze pubblicate. [Confartigianato Ravenna — ipotesi CCNL Metalmeccanica PMI Confapi](https://www.confartigianato.ra.it/news.php?idnews=6528)
...
La ricerca della fascia pomeridiana non ha restituito **nuovi atti certificati con impatto diretto sul calcolo del cedolino privato** rispetto alle run 07/08 h0603 e h1003. L'INPS è in sospensione estiva delle notifiche (Msg 2371/2026, 27/07–31/08/2026): flusso di prassi ridotto al minimo. Agenzia delle Entrate, Gazzetta Ufficiale/Normattiva, Ministero del Lavoro, INL, INAIL e COVIP: nessun atto nuovo calc-critico nella fascia. Ultimi messaggi INPS del 03/08 (n. 2539 istruttoria indennità maltempo, n. 2548 Fondo TLC, n. 2540 dimissioni vittime di violenza) già a registro o fuori perimetro busta paga privata.

**Rinnovi CCNL della finestra — perimetro:** i rinnovi più rilevanti del periodo sono del **comparto pubblico** (Funzioni Locali, ipotesi 21/07/2026; Sanità 2025-2027; Funzioni Centrali/Ministeri), **fuori dal perimetro busta paga privata** di GioIA. Nel privato è emersa l'**ipotesi di rinnovo CCNL Metalmeccanica PMI–Confapi** (⏳ in iter). Nessun rinnovo di CCNL privato di Priorità 1 con tabelle inedite certificate né decorrenza aumenti nella fascia.

**Giurisprudenza recente (contesto, non calc-critica nuova):**
- **Cass. ord. n. 10976/2026** — Legge 104 (permessi/assistenza). ✅ (deposito 2026)
- **Cass. ord. n. 8738/2026** — certificati di malattia. ✅
- **Cass. ord. n. 5051 del 06/03/2026** — festività soppresse computabili come ferie retribuite (fuori finestra 30 gg). ✅
- **Cass. ord. n. 18529/2026** — retribuzione feriale comparabile (già a registro evergreen). ✅
...
- **Riforma disabilità — Msg INPS 2550 del 04/08/2026:** rilascio servizio telematico istanze (D.Lgs. 62/2024). Impatto **indiretto**. ✅
...
- **Detassazione incrementi retributivi 2026:** sostitutiva 5% sugli aumenti da rinnovi CCNL 2024-2026 e 15% su notturno/festivo/turni/reperibilità; esclusi una tantum, scatti anzianità, premi di risultato e quote a TFR (chiarimenti AdE 2026). ✅
...
- **Previdenza complementare:** dal 01/07/2026 plafond deducibilità 5.300 €/anno. ✅
...
- **Conguagli 730/2026 su cedolino agosto** — rimborsi/trattenute in busta di luglio-agosto. ✅ (già in gestione)

**Dataset CCNL (`ccnl_master.json`): invariato** — nessun rinnovo di CCNL privato di Priorità 1 con tabelle inedite certificate né decorrenza aumenti nel giorno. Ipotesi Metalmecc. PMI–Confapi ⏳ da monitorare per la sottoscrizione definitiva. Ultimi aumenti programmati già a master: Metalmeccanica Industria C011, 3ª tranche 01/06/2026 (+53,17 € liv. C3); Commercio Confcommercio +35 € liv. IV dal 01/11/2026.

---

## 3. DIFF vs run precedente (2026-08-07 h1003)

| Tema | Stato 07/08 h1003 | Oggi 07/08 h1603 |
|---|---|---|
...
| Rinnovi CCNL privati | ⏳ ipotesi Metalmecc. PMI–Confapi | invariato ⏳ (in iter) |
| NASpI — dimissioni per violenza di genere (Msg 2540/2026) | ✅ | invariato ✅ |
| Detassazione incrementi retributivi 2026 | ✅ a registro | invariato ✅ |
...
**Nuove norme certificate del settore privato busta paga rispetto a h1003:** 0 con impatto diretto. **Nuovo in iter:** nessuno oltre l'ipotesi Metalmecc. PMI–Confapi già segnalata. **Decadute:** nessuna.
...
| Rinnovo CCNL Metalmecc. PMI–Confapi | Ipotesi di accordo firmata; aumenti tabellari da definire | da definire | Futuri aumenti tabellari + eventuale una tantum | ⏳ | Ipotesi CCNL Confapi |
| Detassazione incrementi retributivi | Sostitutiva 5% su aumenti da rinnovi CCNL 2024-2026; 15% notturno/festivo/turni/reperibilità | 2026 | Minore IRPEF sulle quote agevolate in busta | ✅ | Chiarimenti AdE 2026 |
...
- Imposta sostitutiva IRPEF del **5%** sugli aumenti retributivi 2026 in forza di rinnovi di contrattazione collettiva 2024-2026; **15%** su indennità/maggiorazioni per lavoro notturno, festivo, riposi, turni e reperibilità. **Esclusi:** una tantum, scatti anzianità individuali, premi di risultato con altra disciplina, quote a TFR. Applicata dal sostituto d'imposta. Voce impattata: minore IRPEF sulle quote agevolate. Fonte: chiarimenti Agenzia delle Entrate 2026 (numero circolare da riscontrare su portale AdE).

---

## 6. Parametri di calcolo (per ingest app)

Vedi file `parametri_2026-08-07_1603.json`. Valori IRPEF/INPS/cuneo/TFR/NASpI/INAIL/fringe benefit/indennità malattia-maternità/congedo malattia figlio **invariati** rispetto alle run 2026-08-07 h0603 e h1003.
...
- [ ] Monitorare sottoscrizione definitiva CCNL Metalmecc. PMI–Confapi e relative decorrenze aumenti (ora ⏳ ipotesi)
- [ ] Detassazione incrementi retributivi: verificare sostitutiva 5% (aumenti da rinnovo CCNL 2024-2026) e 15% (notturno/festivo/turni/reperibilità)
...
- [ ] Buoni pasto: soglia esente elettronici 10 €/gg, cartacei 4 €/gg — tassare l'eccedenza
...
- [Wikilabour — Indennità sostitutiva del preavviso](https://www.wikilabour.it/dizionario/licenziamento-e-dimissioni/indennita-sostitutiva-del-preavviso/)
- [Money.it — Indennità di reperibilità in busta paga](https://www.money.it/indennita-di-reperibilita-busta-paga-cos-e-quando-spetta-e-importi)
- [Legge in Chiaro — Permessi per lutto: quanti giorni spettano](https://leggeinchiaro.it/permessi-lutto-familiare-giorni/)
