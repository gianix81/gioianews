...
> **Data ricerca:** 2026-08-02 (domenica) · **Fascia/run:** h1604
> **Destinazione:** dataset app GioIA + checklist paghe
> **Confronto DIFF:** run precedente odierna (h1055) + ultimo report consolidato 2026-08-01 (h2200)
...
Nessuna novità normativa privata con decorrenza operativa oggi. La ricerca pomeridiana conferma il quadro del 1° agosto e della run delle 10:55: **parametri di calcolo 2026 invariati** (IRPEF 23/33/43%, cuneo ≤20.000/20.001–40.000, detassazioni 1/5/15%, INPS 9,19%, plafond prev. compl. 5.300 €); esoneri attivi (under 35 art. 4 DL 62/2026; madri 3+ figli Circ. INPS 82/2026); scadenza 30/09/2026 per gli esoneri DL 60/2024 (Msg. INPS 2451/2026); coefficiente rivalutazione TFR 2,786543%; INAIL minimale/massimale rendita 2026.

**Contesto di contorno (già noto, non nuovo):** CIGO/CISOA rafforzata per caldo estremo (DL 107/2026, Msg. INPS 2418/2026); aggiornamento importi giornalieri per malattia/maternità/TBC (Circ. INPS 75 del 17/07/2026); portabilità del TFR verso i fondi pensione **rinviata dal 01/07 al 01/10/2026** (conversione DL PNRR → L. 50/2026); adesione automatica alla previdenza complementare per i neoassunti dal 01/07/2026 (silenzio-assenso, 60 gg per scelta diversa).

**Comparto pubblico (fuori dal perimetro busta paga privata, segnalato come contesto):** CCNL Scuola/Istruzione 2025-2027 → aumenti e arretrati sul cedolino di agosto per docenti/ATA; ipotesi CCNL Funzioni Centrali 2025-2027 (≈162 € medi mensili per 13 mensilità). Non impattano i CCNL privati del dataset GioIA.

**Dataset CCNL (`ccnl_master.json`): invariato** — nessun rinnovo di Priorità 1 con tabelle inedite certificate né decorrenza aumenti nel giorno. Promemoria tranche già a DB: Autostrade/Trafori +65 € liv. C Sez.1 dal 01/08/2026 (contratto già firmato, non nuovo); Commercio Confcommercio +35 € liv. IV dal 01/11/2026.

---

## 3. DIFF vs run h1055 (02/08) e report consolidato 01/08 (h2200)

| Tema | Stato precedente | Oggi 02/08 (h1604) |
|---|---|---|
| **Incentivo stabilizzazione under 35 (art. 4 DL 62/2026)** | ✅ in vigore dal 01/08; payload scritto il 01/08 | **INVARIATO ✅** — contesto in vigore; nessuna nuova prassi oggi |
| CIGO/CISOA caldo estremo (DL 107/2026, Msg. 2418/2026) | ✅ context | invariato ✅ (nessuna nuova precisazione oggi) |
| Malattia/maternità — importi giornalieri (Circ. INPS 75/2026) | ✅ context (dal 17/07) | invariato ✅ |
...
*Nessun elemento nuovo, cambiato o decaduto sul fronte busta paga privata rispetto alla run delle 10:55. Novità odierne: nessuna con decorrenza operativa.*
...
*Nessuna nuova scheda calc-critica oggi.* Le schede consolidate (incentivo stabilizzazione under 35; parametri fiscali/contributivi 2026) restano valide come da report 2026-08-01. Sintesi operativa dell'unico esonero con avvio recente:
...
- [ItaliaOggi — Caldo, arrivano le tutele speciali: i dettagli dall'INPS](https://www.italiaoggi.it/diritto-e-fisco/caldo-arrivano-le-tutele-speciali-tutti-i-dettagli-dallinps-qxl4dtfn)
...
---
*Log run h1604: freschezza + dedup vs h1055 (02/08) e h2200 (01/08). Esito: nessuna notizia certa NUOVA con impatto busta paga privata → **payload ingest NON creato** (previsto). Parametri e CCNL invariati. Bozza mail di riepilogo creata.*
