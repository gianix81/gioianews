...
> **Data ricerca:** 2026-08-02 (domenica) · **Fascia/run:** h1055
> **Destinazione:** dataset app GioIA + checklist paghe
> **Confronto DIFF:** ultimo report 2026-08-01 (run h2200 consolidata) e run precedenti del 01/08
...
*Domenica 2 agosto 2026: nessuna nuova norma certificata con impatto diretto sulla busta paga del settore privato pubblicata o entrata in vigore oggi.* Il quadro operativo resta quello consolidato ieri (1° agosto). Elementi ancora "caldi" per rilevanza/interazione:

1. ✅ **Incentivo stabilizzazione under 35 — ora IN VIGORE (finestra 1/08–31/12/2026).** Operativo da ieri; domande aperte sul Portale Agevolazioni INPS. Esonero 100% contributi c/datore (escl. INAIL e TFR Fondo Tesoreria), max 500 €/mese per 24 mesi. Base: art. 4 DL 62/2026; Circ. INPS 72/2026; Msg. INPS 2518/2026. *(Già trattato ieri — oggi passa da "novità" a "contesto in vigore".)* [INPS](https://www.inps.it/it/it/inps-comunica/notizie/dettaglio-news-page.news.2026.07.occupazione-giovanile-incentivo-per-la-stabilizzazione-degli-under-35.html)
2. ✅ **Cedolino di agosto 2026: conguaglio 730.** Sul cedolino di agosto compaiono rimborsi/trattenute da modello 730 per chi ha indicato il datore/INPS come sostituto d'imposta. Voce impattata: conguaglio IRPEF da assistenza fiscale. *(Contesto stagionale ricorrente.)* [FiscoeTasse](https://www.fiscoetasse.com/new-rassegna-stampa/3341-busta-paga-dipendenti-2026-cosa-cambia-con-la-manovra.html)

---

## 2. Quadro di sintesi

Nessuna novità normativa privata con decorrenza operativa oggi. La ricerca odierna conferma il quadro del 1° agosto: **parametri di calcolo 2026 invariati** (IRPEF 23/33/43%, cuneo ≤20.000/20.001–40.000, detassazioni 1/5/15%, INPS 9,19%, plafond prev. compl. 5.300 €); esoneri attivi (under 35 art. 4 DL 62/2026; madri 3+ figli Circ. INPS 82/2026); scadenza 30/09/2026 per gli esoneri DL 60/2024 (Msg. INPS 2451/2026); coefficiente rivalutazione TFR 2,786543%; INAIL minimale/massimale rendita 2026.

**Contesto di contorno (già noto, non nuovo):** portabilità del TFR verso i fondi pensione **rinviata dal 01/07 al 01/10/2026** (conversione DL PNRR → L. 50/2026); adesione automatica alla previdenza complementare per i neoassunti dal 01/07/2026 (silenzio-assenso, 60 gg per scelta diversa).

**Comparto pubblico (fuori dal perimetro busta paga privata, segnalato come contesto):** CCNL Istruzione e Ricerca 2025-2027 sottoscritto in via definitiva (parte economica firmata 01/07/2026) → primo cedolino con nuove tabelle ad agosto per docenti/ATA; preintesa CCNL Funzioni Locali 2025-2027 firmata il 21/07/2026 (aumenti fino a ~154 € lordi, ⏳ in attesa di sottoscrizione definitiva). Non impattano i CCNL privati del dataset GioIA.

**Dataset CCNL (`ccnl_master.json`): invariato** — nessun rinnovo di Priorità 1 con tabelle inedite certificate né decorrenza aumenti nel giorno. Promemoria tranche già a DB: Commercio Confcommercio +35 € liv. IV dal 01/11/2026.

---

## 3. DIFF vs ultimo report (2026-08-01 h2200)

| Tema | Stato 01/08 | Oggi 02/08 (h1055) |
|---|---|---|
| **Incentivo stabilizzazione under 35 (art. 4 DL 62/2026)** | NUOVO 🔥 ✅ operativo dal 01/08 | **INVARIATO ✅** — ora contesto "in vigore"; nessuna nuova prassi oggi |
...
| TFR — portabilità ai fondi pensione | rinvio a 01/10/2026 (L.50/2026) — context | invariato ⏳ (nessuna nuova prassi) |
...
| Comparto pubblico (Istruzione/ATA, Funzioni Locali) | — | contesto informativo (fuori perimetro privato) |

*Nessun elemento nuovo, cambiato o decaduto sul fronte busta paga privata. Novità odierne: nessuna con decorrenza operativa.*
...
|---|---|---|---|---|---|
| Incentivo stabilizzazione under 35 (art. 4 DL 62/2026) | Esonero 100% contributi c/datore (escl. INAIL e TFR Fondo Tesoreria), max 24 mesi, tetto 500 €/mese | In vigore 01/08–31/12/2026 | Voce contributi c/datore azzerata entro plafond | ✅ (estremi da riscontrare INPS) | Circ. INPS 72/2026; Msg. INPS 2518/2026 |
...
*Nessuna nuova scheda calc-critica oggi.* La scheda dell'incentivo stabilizzazione under 35 resta valida come da report 2026-08-01 (invariata). Sintesi operativa:
...
- **Decorrenza:** trasformazioni TD→TI e domande dal 01/08 al 31/12/2026.
...
- **Fonte:** art. 4 DL 62/2026; Circ. INPS 72/2026; Msg. INPS 2518 del 29/07/2026.
...
| Incentivo stabilizzazione under 35 | 100% c/datore, max 500 €/mese, max 24 mesi | 01/08/2026–31/12/2026 | ✅ | art. 4 DL 62/2026; Circ. INPS 72/2026; Msg. 2518/2026 |
...
- [ ] **Incentivo stabilizzazione under 35:** per trasformazioni TD→TI dal 01/08/2026, verificare requisiti (under 35, mai stabilizzato, TD instaurato entro 30/04/2026 e ≤12 mesi); esonero contributi c/datore max 500 €/mese per 24 mesi; domanda sul Portale Agevolazioni INPS; conguaglio UniEmens.
- [ ] **Cedolino agosto:** gestire conguaglio 730 (rimborsi/trattenute IRPEF da assistenza fiscale).
...
- [diritto.it — TFR e pensioni: portabilità rinviata a ottobre 2026](https://www.diritto.it/tfr-e-pensioni-portabilita-rinviata-a-ottobre-2026/)
- [Lavoro e Diritti — Rinnovo CCNL Funzioni Locali 2025-2027 (preintesa)](https://www.lavoroediritti.com/pubblico-impiego/rinnovo-ccnl-enti-locali-preintesa-2025-2027)
...
---
*Log run h1055: freschezza + dedup vs 01/08 (h2200 e run precedenti). Esito: nessuna notizia certa NUOVA con impatto busta paga privata → **payload ingest NON creato** (previsto). Parametri e CCNL invariati. Bozza mail di riepilogo creata.*
